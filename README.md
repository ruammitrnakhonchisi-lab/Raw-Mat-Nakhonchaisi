...
- **เบิกออก (Stock Out)** — บันทึกเบิกใช้ พร้อมแผนก/เลขที่ใบสั่งผลิต ตรวจสอบยอดคงเหลือก่อนเบิกอัตโนมัติ — **เฉพาะวัตถุดิบหมวด "PC wire"**: เลือกเบิกเจาะจงตาม Coil (อ่านเลขจากแท็กเหล็กที่ติดมากับม้วนลวด) ระบบตัดยอดคงเหลือของ coil นั้นโดยตรง ไม่ปนกับ coil อื่น
