...
- **รับเข้า (Stock In)** — บันทึกรับวัตถุดิบพร้อม Lot/Batch, วันหมดอายุ, ราคา, เลขที่ PO, auto-fill ราคา/ผู้จำหน่ายจากทะเบียนวัตถุดิบ, เพิ่มวัตถุดิบใหม่ได้ทันทีจากหน้านี้ถ้ายังไม่มี SKU ในระบบ, ดูประวัติรับเข้าล่าสุดและยกเลิกรายการที่ผิดพลาดได้ (admin) — บันทึกแบบ atomic ทั้งหมดผ่าน Postgres function เดียว — **เฉพาะวัตถุดิบหมวด "PC wire"**: คีย์เลข Coil จากใบส่งของทีละม้วน นับหน่วยเป็น "ขด" (1 coil = 1 ขด ไม่ใช้น้ำหนัก) รับเข้าได้หลาย coil ในใบส่งของเดียวกัน
- **เบิกออก (Stock Out)** — บันทึกเบิกใช้ พร้อมแผนก/เลขที่ใบสั่งผลิต ตรวจสอบยอดคงเหลือก่อนเบิกอัตโนมัติ — **เฉพาะวัตถุดิบหมวด "PC wire"**: เลือกเบิกเจาะจงตาม Coil (อ่านเลขจากแท็กเหล็กที่ติดมากับม้วนลวด) เบิกทีละ 1 ขด ระบบตัดยอดคงเหลือของ coil นั้นโดยตรง ไม่ปนกับ coil อื่น พร้อมเลือก "ใช้งาน" ว่าเบิกไปผลิตอะไรจาก dropdown ที่กำหนดไว้ (กันพิมพ์ผิด)
